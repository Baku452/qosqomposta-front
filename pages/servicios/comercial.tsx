  ...
  return (
    <>
      ...
      {sectionsToAppear.map((sectionService, index) => {
        const { id, title, content, accordionItems, imageSection, advertise, buttonCTA } =
          sectionService;
        return (
          <ServiceSection
            key={id}
          ...
          <div className="mx-auto max-w-3xl basis-2/3">
            ...
            <article>
              <p className="my-5">
                ...
                social y ambientalmente responsable. Nuestros planes de manejo de residuos
                sólidos institucionales incluyen capacitación al personal y promoción por
                redes sociales.
              </p>
              <h3>Recojo y Acopio Comercial</h3>
              <p>
                Uds. solo juntan sus residuos compostables en el balde y nosotros nos
                encargamos del resto. Te brindamos: baldes limpios, control de pesos,
                promoción de impacto ambiental con tu logo cada 6 meses, sticker en tu
                local comercial con QR del impacto ambiental, para que tú y tus clientes
                estén siempre informados.
              </p>
              <br />
              <h3> Compostaje in-situ</h3>
              <p>
                Para todos aquellos comercios que tengan espacio de áreas verdes, ponemos
                a disposición nuestro taller de compostaje e instalación de composteras,
                insumos y acompañamiento hasta la primera cosecha de compost. Uds mismos
                pueden gestionar sus residuos compostables y reducir dramaticamente los
                desperdicios que terminan en botaderos. Todas las empresas, restaurantes y
                hoteles interesados en gestionar sus residuos sólidos, pueden escribirnos

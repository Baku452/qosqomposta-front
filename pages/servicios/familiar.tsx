    ...
    <>
      ...
      >
        <div className="basis-2/3 p-14">
          ...
          <p className="text-lg">
            Para todas las personas que escogen recojo o acopio individual, ¡Les tenemos
            novedades! Desde ahora, podrás juntar tus residuos y empezar el proceso de
            compostaje en el balde, gracias a los microQomposteros: bacterias y hongos que

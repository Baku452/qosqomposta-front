export const firebaseAuthErrorCodes = [
    ...
    },
    {
        ...
        message:
            'La aplicación no está autorizada para acceder a Firebase Authentication.',
    },
    {
    ...
    },
    {
        ...
        message:
            'Debe verificar su nueva dirección de correo electrónico antes de usarla.',
    },
    {
        code: 'auth/email-already-in-use',
        message:
            'Ya hay una cuenta con la dirección de correo electrónico proporcionada.',
    },
    {
    ...
    { code: 'auth/already-initialized', message: 'Already initialized' },
    {
        ...
        message:
            'Demasiados intentos de inicio de sesión. Intenta más tarde por seguridad.',
    },
];

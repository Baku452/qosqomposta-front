import { COSTO_RECOJO_RECICLABLES_ECOLADRILLOS } from './main.config';
...
export const RECOLECCION_RESIDUOS_ORGANICOS_IMG =
    'https://res.cloudinary.com/https-qosqomposta-com/image/upload/v1675826957/servicios/recoleccion-residuos_ap56qk.png';
